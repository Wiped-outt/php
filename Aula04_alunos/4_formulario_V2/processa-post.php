...
<body>
    ...
    <?php
        ...
        // Operador de coaliscência nula (Verifica se o que está a esquerda existe (interesses), senão pega o da direita, neste caso vazio [])
...
<?php 
} // fim id/else da vadilação de campos obrigatórios
?>
